...
RSpec.describe 'user_groups', type: :request do
  path '/user_groups' do
    post 'create user_group' do
      ...
      parameter name: :owner_id, in: :query, type: :integer, description: '사용자 검증을 위해 사용', required: true      
  ...
  path '/user_groups/{id}' do
    ...
    delete 'delete user_group' do
      tags 'user_group'
      parameter name: :owner_id, in: :query, type: :integer, description: '사용자 검증을 위해 사용', required: true      
      parameter name: :group_id, in: :query, type: :integer, description: '사용자 검증을 위해 사용', required: true
